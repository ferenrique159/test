    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12 top"> &nbsp; </div>
            ...
            <div class="col-md-6">
                ...
                <form method="post" action="index.php?/editar_controller/editarLogin/editar2" id="shearchclient">
                     ...
                     <div class="form-group">
                        <div class="form-row">
                            ...
                            <div class="col-md-6" style="margin-left: 90px; margin-top: -38px;">
                                    <button type="submit" class="float-right btn btn-warning">buscar</button>
                            </div>
                        </div>
                    </div>
